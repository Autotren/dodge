...
const CACHE_NAME = "dodge-cache";
const OFFLINE_URL = "dodge.offline.html";
// Files that will be cached on load.
const CACHED_FILES = ["dodge.html","dodge.js","dodge.wasm","dodge.pck","dodge.offline.html","dodge.icon.png","dodge.apple-touch-icon.png"];
